...
export const GradientCard: React.FC<GradientCardProps> = ({ title, description, icon }) => {
  ...
  return (
    <motion.div
      ref={cardRef}
      className="relative rounded-[24px] overflow-hidden cursor-pointer h-64"
      style={{
    ...
    >
      ...
      {/* Light transparent background with blue-purple gradient */}
      <motion.div
        className="absolute inset-0 z-0"
        style={{
          background: "linear-gradient(180deg, rgba(14, 19, 31, 0.3) 0%, rgba(14, 19, 31, 0.15) 70%)",
        }}
        animate={{
          z: -1
        }}
      ...
      >
        ...
        >
          ...
          <div className="flex items-center justify-center w-full h-full relative z-10 text-lg text-white">
            {icon}
          </div>
        </motion.div>
